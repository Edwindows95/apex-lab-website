var ApexShaders = (() => {
  ...
  __export(index_exports, {
    ...
    colorPanelsFragmentShader: () => colorPanelsFragmentShader,
    colorPanelsMeta: () => colorPanelsMeta,
    defaultObjectSizing: () => defaultObjectSizing,
    defaultPatternSizing: () => defaultPatternSizing,
    ditheringFragmentShader: () => ditheringFragmentShader,
    dotGridFragmentShader: () => dotGridFragmentShader,
    dotOrbitFragmentShader: () => dotOrbitFragmentShader,
    dotOrbitMeta: () => dotOrbitMeta,
    emptyPixel: () => emptyPixel,
    flutedGlassFragmentShader: () => flutedGlassFragmentShader,
    gemSmokeFragmentShader: () => gemSmokeFragmentShader,
    gemSmokeMeta: () => gemSmokeMeta,
    getShaderColorFromString: () => getShaderColorFromString,
    getShaderNoiseTexture: () => getShaderNoiseTexture,
    godRaysFragmentShader: () => godRaysFragmentShader,
    godRaysMeta: () => godRaysMeta,
    grainGradientFragmentShader: () => grainGradientFragmentShader,
    grainGradientMeta: () => grainGradientMeta,
    halftoneCmykFragmentShader: () => halftoneCmykFragmentShader,
    halftoneDotsFragmentShader: () => halftoneDotsFragmentShader,
    heatmapFragmentShader: () => heatmapFragmentShader,
    heatmapMeta: () => heatmapMeta,
    imageDitheringFragmentShader: () => imageDitheringFragmentShader,
    isPaperShaderElement: () => isPaperShaderElement,
    liquidMetalFragmentShader: () => liquidMetalFragmentShader,
    meshGradientFragmentShader: () => meshGradientFragmentShader,
    meshGradientMeta: () => meshGradientMeta,
    metaballsFragmentShader: () => metaballsFragmentShader,
    metaballsMeta: () => metaballsMeta,
    neuroNoiseFragmentShader: () => neuroNoiseFragmentShader,
    paperTextureFragmentShader: () => paperTextureFragmentShader,
    perlinNoiseFragmentShader: () => perlinNoiseFragmentShader,
    pulsingBorderFragmentShader: () => pulsingBorderFragmentShader,
    pulsingBorderMeta: () => pulsingBorderMeta,
    simplexNoiseFragmentShader: () => simplexNoiseFragmentShader,
    simplexNoiseMeta: () => simplexNoiseMeta,
    smokeRingFragmentShader: () => smokeRingFragmentShader,
    smokeRingMeta: () => smokeRingMeta,
    spiralFragmentShader: () => spiralFragmentShader,
    staticMeshGradientFragmentShader: () => staticMeshGradientFragmentShader,
    staticMeshGradientMeta: () => staticMeshGradientMeta,
    staticRadialGradientFragmentShader: () => staticRadialGradientFragmentShader,
    staticRadialGradientMeta: () => staticRadialGradientMeta,
    swirlFragmentShader: () => swirlFragmentShader,
    swirlMeta: () => swirlMeta,
    toProcessedGemSmoke: () => toProcessedGemSmoke,
    toProcessedHeatmap: () => toProcessedHeatmap,
    toProcessedLiquidMetal: () => toProcessedLiquidMetal,
    voronoiFragmentShader: () => voronoiFragmentShader,
    voronoiMeta: () => voronoiMeta,
    warpFragmentShader: () => warpFragmentShader,
    warpMeta: () => warpMeta,
    waterFragmentShader: () => waterFragmentShader,
    wavesFragmentShader: () => wavesFragmentShader
  });

  // js/shaders-dist/vertex-shader.js
...
void main() {
  ...
  // js/shaders-dist/shader-mount.js
  ...
  // js/shaders-dist/shader-sizing.js
  ...
  // js/shaders-dist/shader-utils.js
  var declarePI = `
...
`;
  ...
  // js/shaders-dist/shaders/mesh-gradient.js
...
`;
  ...
  // js/shaders-dist/shaders/smoke-ring.js
  var smokeRingMeta = {
    maxColorCount: 10,
...
`;
  ...
  // js/shaders-dist/shaders/neuro-noise.js
...
`;
  ...
  // js/shaders-dist/shaders/dot-orbit.js
  var dotOrbitMeta = {
    maxColorCount: 10
  };
...
`;
  ...
  // js/shaders-dist/shaders/dot-grid.js
...
`;
  ...
  // js/shaders-dist/shaders/simplex-noise.js
...
`;
  ...
  // js/shaders-dist/shaders/metaballs.js
  var metaballsMeta = {
    maxColorCount: 8,
    maxBallsCount: 20
  };
...
`;
  ...
  // js/shaders-dist/shaders/perlin-noise.js
...
`;
  ...
  // js/shaders-dist/shaders/voronoi.js
  var voronoiMeta = {
    maxColorCount: 5
  };
...
`;
  ...
  // js/shaders-dist/shaders/waves.js
...
`;
  ...
  // js/shaders-dist/shaders/warp.js
  var warpMeta = {
    maxColorCount: 10
  };
...
`;
  ...
  // js/shaders-dist/shaders/god-rays.js
  var godRaysMeta = {
    maxColorCount: 5
  };
...
`;
  ...
  // js/shaders-dist/shaders/spiral.js
...
`;
  ...
  // js/shaders-dist/shaders/swirl.js
  var swirlMeta = {
    maxColorCount: 10
  };
...
`;
  ...
  // js/shaders-dist/shaders/dithering.js
...
`;
  ...
  // js/shaders-dist/shaders/grain-gradient.js
...
`;
  ...
  // js/shaders-dist/shaders/pulsing-border.js
...
void main() {
  ...
  // js/shaders-dist/shaders/color-panels.js
  var colorPanelsMeta = {
    maxColorCount: 7
  };
...
`;
  ...
  // js/shaders-dist/shaders/static-mesh-gradient.js
...
`;
  ...
  // js/shaders-dist/shaders/static-radial-gradient.js
...
`;
  ...
  // js/shaders-dist/shaders/paper-texture.js
...
`;
  ...
  // js/shaders-dist/shaders/water.js
...
`;
  ...
  // js/shaders-dist/shaders/fluted-glass.js
...
`;
  ...
  // js/shaders-dist/shaders/image-dithering.js
...
`;
  ...
  // js/shaders-dist/shaders/heatmap.js
  var heatmapMeta = {
    maxColorCount: 10
  };
...
`;
  ...
  // js/shaders-dist/shaders/liquid-metal.js
...
`;
  ...
  // js/shaders-dist/shaders/halftone-dots.js
...
`;
  ...
  // js/shaders-dist/shaders/halftone-cmyk.js
...
`;
  ...
  // js/shaders-dist/shaders/gem-smoke.js
  var gemSmokeMeta = {
    maxColorCount: 6
  };
...
`;
  ...
  // js/shaders-dist/get-shader-color-from-string.js
  ...
  // js/shaders-dist/get-shader-noise-texture.js
  ...
  // js/shaders-dist/empty-pixel.js
